<?php
    ...
    class JefeEstudio {
        ...
        public function obtenerPermisosUsuario($centro){
            ...
            $sql = "SELECT idPermisoUsuario,descripcionPermiso, nombre, apellidos, usuarios.id_usuario, observaciones ,nombreDocumento, fechaInicio, fechaFin, nombreEstado  FROM tipoPermiso_has_usuario 
